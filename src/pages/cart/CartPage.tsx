  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center px-4">
        ...
        <h2 className="text-2xl font-extrabold text-gray-900 mb-2">Giỏ hàng của bạn đang trống</h2>
        <p className="text-gray-500 mb-8 text-center max-w-md">
          Chưa có ly trà sữa nào được chọn. Hãy quay lại thực đơn và chọn cho mình một hương vị yêu thích nhé!
        </p>
        <Link 
          to="/" 
    ...
    <div className="bg-gray-50 min-h-screen py-10">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Bạn đang có {cartCount} sản phẩm trong giỏ</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3 space-y-4">
              ...
              >
                ...
                <div className="flex-grow flex flex-col justify-between">
                  <div className="flex justify-between items-start gap-4">
                    <div>
                      <Link to={`/product/${item.productId}`} className="text-lg font-bold text-gray-900 hover:text-amber-600 transition-colors line-clamp-1">
                        {item.productName}
                      </Link>
                      
                      {/* Hiển thị cấu hình khách chọn (Cực kỳ quan trọng cho F&B) */}
                      <div className="text-sm text-gray-500 mt-1 space-y-0.5">
                        <p><span className="font-medium text-gray-700">Size:</span> {item.sizeName}</p>
                        <p><span className="font-medium text-gray-700">Đường/Đá:</span> {item.sugarLevel} Đường, {item.iceLevel} Đá</p>
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-50">
                    <div className="text-lg font-extrabold text-amber-600">
                      {formatCurrency(item.unitPrice)} <span className="text-xs text-gray-400 font-normal">/ ly</span>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center bg-gray-50 border border-gray-200 rounded-lg h-9">
                        ...
                        <div className="w-8 font-bold text-center text-sm">{item.quantity}</div>
                        <button 
                          onClick={() => updateQuantity(item.signature, item.quantity + 1)}
            ...
            <Link to="/" className="inline-flex items-center gap-2 text-amber-600 font-medium hover:text-amber-700 transition-colors mt-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-28">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between text-gray-600">
                  ...
                  <span className="text-sm italic">Sẽ tính ở bước sau</span>
                </div>
                <div className="flex justify-between text-gray-600">
                  <span>Khuyến mãi</span>
                  <span className="text-sm italic text-amber-600">Chọn mã ở bước sau</span>
                </div>
              </div>
              ...
              <button className="w-full bg-gray-900 text-white rounded-xl py-4 font-bold text-lg hover:bg-amber-500 transition-colors shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
